...
<body>
    ...
    <section>
        <div class="js-personal-post ">
            <button onclick="mypost.new_topic()">+ Start New Topic</button>
            <form onsubmit="mypost.submit(event)" method="post" class="js-start-topic class_42 hide " >
                <div class="">
...
<script src="mypost.js?v22"></script>
</html>
        ...
        <div class='newsCard news-Slide-up rounded-4 m-4'>
                ...
                <div class='newsCaption rounded-4 shadow-sm'>
                    <div style="display: flow;">
                        ...
                        <div class="js-std-desc newsCaption-content px-1" style="font-size:1rem;" >
                            is simply dummy text of the printing and typesetting industry. 
                            Lorem Ipsum has been the industry's standard dummy text ever 
                            since the 1500s, when an unknown printer took a galley of 
                            type and scrambled it to make a type specimen book.
                        </div>
                        <p class="read px-2 mt-2"><a class='js-std-link' href='#' style="text-decoration: none; color: white; font-size:13px;"><i class="fa-solid fa-circle-info"> </i> READ MORE</a></p>   
                    ...
                    if(ajax.status == 200){
                        ...
                        if(obj.success){
                            ...
                            for (var i = 0; i < obj.rows.length; i++) {
                                ...
                                forumCard.querySelector(".js-std-desc").innerHTML = `${obj.rows[i].std_desc}`;
